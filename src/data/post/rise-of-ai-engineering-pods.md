...
**Two: Total cost of ownership.** So what does a working pod actually cost to run? Estimates land around 30 to 40 thousand dollars a month in model spend per pod. I see these numbers in the AI adoption dashboards and that baffles me. So yes, cheaper than the people. And then Gartner puts a fence around the celebration and projects that spending on AI coding agents will [surpass the average developer's salary by 2028](https://devops.com/ai-coding-costs-could-exceed-developer-salaries-gartner-warns/).
