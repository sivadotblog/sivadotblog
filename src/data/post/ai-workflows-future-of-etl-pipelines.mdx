---
publishDate: 2025-12-18T22:46:00-05:00
title: 'AI Workflows: Future of ETL Pipelines'
excerpt: 'What if, instead of writing pipelines, engineers just described the outcome? Here’s my take on how AI will change how data engineers build pipelines.'
image: '~/assets/images/post/ai-workflows-future-of-etl-pipelines.png'
category: 'Enterprise Strategies'
tags: ['AI Strategies']
metadata:
  title: 'AI Workflows: Future of ETL Pipelines'
  description: 'What if, instead of writing pipelines, engineers just described the outcome? Here’s my take on how AI will change how data engineers build pipelines.'
---
...
<div style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;">
  <iframe
    src="https://www.linkedin.com/embed/feed/update/urn:li:share:7404934835095547904?collapsed=1"
    title="Andrew Ng's LinkedIn post about AI creating a Snake game"
    loading="lazy"
    allowfullscreen
...
[View this post on LinkedIn ↗](https://www.linkedin.com/feed/update/urn:li:share:7404934835095547904/)
